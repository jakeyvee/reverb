...
export const EXTRACTION_SYSTEM_PROMPT = [
  ...
  "- For teacher_corrections: only emit when the teacher visibly corrects a student. studentSpeaker MUST be student_vincent or student_gf — never teacher or unknown. Include a numeric `confidence` in [0,1] reflecting how certain you are this was a real correction (rather than e.g. a hedge or a follow-up question) — the session selector hides drills below 0.3 and labels the 0.3–0.7 band as uncertain.",
  ...
  '  "teacher_corrections": [ { "studentSpeaker": "student_vincent", "segmentId": "S1", "utterance": "...", "correction": "...", "rationale": "...", "category": "grammar|vocab|pronunciation|usage|other", "severity": "minor|moderate|major", "confidence": 0.85 } ]',
  "}",
